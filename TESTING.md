...
- Silent front-camera constraints and MIME fallback.
- Opening, starting, stopping, chunk assembly, and track shutdown.
- Privacy acceptance and the sole persistent preference.
...
- [ ] Inspect Local Storage, IndexedDB, and Cache Storage; only the intro boolean and static shell may persist.
